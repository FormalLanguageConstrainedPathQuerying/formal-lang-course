...
class FiniteAutomaton:
    """
    Класс, представляющий конечный автомат, который может быть либо
    недетерминированным конечным автоматом (НКА), либо представлен матрично.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Аргументы:
            ...
            bad (bool, optional): Флаг, указывающий, является ли автомат "плохим".
