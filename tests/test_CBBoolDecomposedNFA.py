...
def test_cross_cb_boolean_matrices():
    ...
    for test in tests:
        m1 = CBBoolDecomposedNFA(test.graph1_nfa)
        m2 = CBBoolDecomposedNFA(test.graph2_nfa)
        m3 = m1 & m2
        nfa = m3.to_nfa()
