...
@pytest.mark.parametrize(
    ...
    [
        ("a*|b", None, None, set(product(range(4), range(4))).union({(0, 4), (4, 5), (5, 0)})),
...
def test_querying(graph, regex, start_node_nums, final_node_nums, expected_reachable_state_nums):
    actual_reachable_state_nums = regular_path_querying(graph.graph, regex, start_node_nums, final_node_nums)
