...
def test_labels():
    assert graph_info.labels == {'seeAlso', 'comment', 'subPropertyOf', 'rest', 'type', 'creator', 'inverseOf', 'label',
                                 'description', 'unionOf', 'domain', 'range', 'example', 'scopeNote', 'contributor',
                                 'title', 'subClassOf', 'definition', 'first', 'disjointWith', 'isDefinedBy'}
