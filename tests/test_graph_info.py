...
from project.graph_info import GraphInfo, get_graph_info, load_graph, create_and_save_dot
...
def test_get_graph_info_nonempty_graph():
    ...
    expected_graph_info = GraphInfo(
        number_of_nodes=10, number_of_edges=11, labels={"a", "b", "c", "d", "e", "f", "g", "i", "k", "l"}
    )
    actual_graph_info = get_graph_info(graph)
