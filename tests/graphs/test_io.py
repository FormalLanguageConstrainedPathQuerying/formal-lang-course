...
class TestLoadingGraph:
    def test_load_graph(self):
        with pytest.raises(Exception):
            load_graph("not_exists")


class TestLoadingGraphInfo:
...
class TestSavingLabeledTwoCyclesGraph:
    def test_labeled_two_cycles_graph_as_dot(self):
