...
class TestGraph:
    ...
    def test_graph_info_pizza(self):
        graph_info_pizza = (671, 1980,
                            ['disjointWith', 'type', 'subClassOf', 'onProperty', 'first', 'rest', 'someValuesFrom',
                             'label', 'allValuesFrom', 'comment', 'unionOf', 'equivalentClass', 'intersectionOf',
                             'range', 'domain', 'hasValue', 'distinctMembers', 'subPropertyOf', 'complementOf',
